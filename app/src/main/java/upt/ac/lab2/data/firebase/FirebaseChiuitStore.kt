package upt.ac.lab2.data.firebase
...
class FirebaseChiuitStore : ChiuitRepository {
    ...
    override fun getAll(): Flow<List<Chiuit>> = callbackFlow {
        val listener = object : ValueEventListener {
            ...
            override fun onDataChange(p0: DataSnapshot) {
                ...
                // TODO 1: Iterate through the children, get the node value and
    ...
    override fun addChiuit(chiuit: Chiuit) {
        // TODO 2: Insert the object into database - don't forget to use the right model.
    }
    ...
    override fun removeChiuit(chiuit: Chiuit) {
        database.addListenerForSingleValueEvent(object : ValueEventListener {
            ...
            override fun onDataChange(p0: DataSnapshot) {
                ...
                // TODO 3: Iterate through the children and find the matching node,
